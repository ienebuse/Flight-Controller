...
#ifndef DRIVERS_SENSORS_QMC5883L_H_
#define DRIVERS_SENSORS_QMC5883L_H_
...
private:
	typedef struct CalibData {
		Vector_t<float> scale = {.x = 1.26126468, .y = 0.87051338, .z = 0.944824457};
		Vector_t<float> offset = {.x = -2652.5, .y = 902.5, .z = 87.5};
	}CalibData;
...
#endif /* DRIVERS_SENSORS_QMC5883L_H_ */
